...
const MetaTraderConfig = (() => {
    ...
    const actions_info = {
        ...
        password_change: {
            ...
            success_msg  : response => localize('The [_1] password of account number [_2] has been changed.', [response.echo_req.password_type, getDisplayLogin(response.echo_req.account_id)]),
    ...
    const fields = {
        ...
        password_change: {
            ...
            additional_fields:
                acc_type => ({
                    account_id: getAccountsInfo(acc_type).info.login,
                    platform  : 'mt5',
                }),
        },
        password_reset: {
