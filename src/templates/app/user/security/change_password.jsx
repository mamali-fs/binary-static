...
const ChangePassword = () => (
    <React.Fragment>
        ...
        <p className='notice-msg'>{it.L('We’ve upgraded our system to support a single, more secure password across all of Deriv/Binary.com. Once you’ve set a new password, you can use it to log into all your Deriv/Binary.com, and DMT5/MT5 accounts.')}</p>
