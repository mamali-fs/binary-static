...
const ChangePassword = () => (
    <React.Fragment>
        ...
        <p className='notice-msg'>{it.L('We’ve upgraded our system to support a single, more secure password across all of Deriv/[_1]. Once you’ve set a new password, you can use it to log into all your Deriv/[_1], and DMT5/MT5 accounts.', it.website_name)}</p>
